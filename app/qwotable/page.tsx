    ...
    return (
        <div className="bg-[#f9f9ff] flex flex-col h-full">
            <header className="flex flex-row items-center space-x-5 w-4/5 mx-auto mt-5">
                ...
                <p className="text-3xl font-bold text-[#274777]">Qwotable</p>
            </header>
            <div className="bg-[#ffdad6] py-7 mt-5">
                <div className="w-4/5 mx-auto flex flex-col items-center">
                    <p className="text-[#93000a] text-center font-bold w-full">Qwotable's development has
            ...
            <TwoPaneImageLayout image={qwotableOverview}>
                <p className="text-3xl md:text-5xl mt-10 text-[#274777]">Read quotes from a big datasource</p>
                <p className="mt-5 text-[#274777]">Qwotable's datasource contains 78 quotes from movies, TV-shows, books, speeches and songs</p>
            </TwoPaneImageLayout>
            <TwoPaneImageLayoutReversed image={qwotableRandomAndFavorites}>
                <p className="text-3xl md:text-5xl mt-10 text-[#274777]">Favoritize the quotes you love</p>
                <p className="mt-5 text-[#274777]">You can add quotes you love to your favorites. They will show up when you open the app, prominently on the home-page.</p>
            </TwoPaneImageLayoutReversed>
            <TwoPaneImageLayout image={qwotableOwnQuotes}>
                <p className="text-3xl md:text-5xl mt-10 text-[#274777]">Add your own quotes</p>
                <p className="mt-5 text-[#274777]">Qwotable lets you add your own quotes to your app. And if you want to, you can include them at the random-quotes-card.</p>
            </TwoPaneImageLayout>
